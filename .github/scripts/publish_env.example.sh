...
# App Store Connect (local --testflight / --notarize) is NOT configured here.
# Keep ASC secrets under ~/.config/enjoy-player/ (see docs/packaging.md):
#   asc.env                 # KEY_ID + ISSUER_ID
