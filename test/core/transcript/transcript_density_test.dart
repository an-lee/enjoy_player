...
void main() {
  group('TranscriptDensity', () {
    ...
    testWidgets('desktop platform returns full values', (tester) async {
      ...
      expect(density.lineVerticalPadding, 10);
      expect(density.lineInterGap, 8);
      expect(density.headerBodyGap, 4);
      expect(density.primarySecondaryGap, 8);
      expect(density.secondaryLeftPadding, 12);
      expect(density.bodyHeight, 1.6);
      expect(density.secondaryHeight, 1.55);
      ...
      expect(density.echoBottomPanelGap, 16);
