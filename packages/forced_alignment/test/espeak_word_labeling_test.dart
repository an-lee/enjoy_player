...
void main() {
  ...
  const cue1Events = [
    (1, 3, 0), (5, 2, 165), (12, 8, 420), (21, 7, 929), (29, 2, 1236),
    (32, 2, 1411), (35, 6, 1512), (42, 2, 1861), (45, 3, 1980), (59, 2, 2703),
    (62, 1, 2819), (64, 10, 2874), (75, 2, 3431), (82, 6, 3660), (89, 1, 3951),
    (92, 1, 4128), (95, 5, 4357),
  ];
  const cue2 =
  ...
  const cue2Events = [
    (1, 2, 0), (4, 3, 146), (8, 5, 345), (14, 2, 768), (17, 4, 905),
    (22, 8, 1166), (31, 4, 1713), (36, 5, 1887), (42, 3, 2160), (46, 2, 2368),
    (47, 2, 2848), (49, 5, 3215), (55, 3, 3517), (60, 2, 4056), (63, 3, 4213),
    (67, 4, 4421), (72, 2, 4626), (75, 5, 4780), (81, 8, 5079), (91, 5, 5695),
  ];
  const cue3 =
  ...
  const cue3Events = [
    (1, 1, 0), (3, 5, 62), (16, 3, 636), (20, 2, 807), (23, 7, 989),
    (31, 2, 1268), (34, 1, 1433), (36, 5, 1523), (42, 6, 1857), (49, 5, 2171),
    (55, 2, 2502), (60, 5, 2651), (66, 6, 2985), (73, 0, 3293), (79, 5, 3791),
    (85, 6, 4030), (92, 6, 4454), (99, 2, 4807), (102, 4, 4938), (107, 0, 5196),
    (112, 2, 5684), (115, 1, 5745), (117, 5, 5822), (123, 9, 6155),
  ];
  ...
  test('mapWordEventsToTokenSpans resolves the documented collisions', () {
    ...
    final owners = mapWordEventsToTokenSpans(spans, const [
      0, 3, 7, 13, 16, 21, 30, 35, 41, 45, 46, 48, 54, 59, 62, 66, 71, 74, 80,
      90,
    ]);
